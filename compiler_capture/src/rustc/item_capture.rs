...
pub(super) fn capture_adt<'tcx>(builder: &mut DeltaCollector, tcx: TyCtxt<'tcx>, def_id: DefId, cache: &mut HashMap<DefId, NodeId>, metadata: &FrontendMetadata) -> Option<NodeId> {
...
pub(super) fn capture_type_alias<'tcx>(builder: &mut DeltaCollector, tcx: TyCtxt<'tcx>, def_id: DefId, cache: &mut HashMap<DefId, NodeId>, metadata: &FrontendMetadata) -> Option<NodeId> {
    if let Some(id) = cache.get(&def_id) {
        return Some(id.clone());
    }
    let raw_def_path = tcx.def_path_str(def_id);
...
pub(super) fn capture_const_static<'tcx>(builder: &mut DeltaCollector, tcx: TyCtxt<'tcx>, def_id: DefId, cache: &mut HashMap<DefId, NodeId>, metadata: &FrontendMetadata) -> Option<NodeId> {
    if let Some(id) = cache.get(&def_id) {
        return Some(id.clone());
    }
    let raw_def_path = tcx.def_path_str(def_id);
...
pub(super) fn capture_mod<'tcx>(builder: &mut DeltaCollector, tcx: TyCtxt<'tcx>, def_id: DefId, cache: &mut HashMap<DefId, NodeId>, metadata: &FrontendMetadata) -> Option<NodeId> {
    if let Some(id) = cache.get(&def_id) {
        return Some(id.clone());
    }
    let raw_def_path = tcx.def_path_str(def_id);
