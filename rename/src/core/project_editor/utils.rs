...
pub(super) fn build_symbol_index(project_root: &Path, registry: &NodeRegistry) -> Result<SymbolIndex> {
...
pub(super) fn find_project_root(registry: &NodeRegistry) -> Result<Option<PathBuf>> {
...
pub(super) fn find_project_root_sync(registry: &NodeRegistry) -> Option<PathBuf> {
