...
impl RewriteBuffer {
    ...
    pub fn queue_edit(&mut self, edit: TextEdit) -> Result<()> {
    ...
    fn validate_bounds(&self, edit: &TextEdit) -> Result<()> {
...
fn edits_conflict(existing: &TextEdit, new_edit: &TextEdit) -> bool {
