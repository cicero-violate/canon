...
fn build_graph_deltas<'tcx>(tcx: TyCtxt<'tcx>, metadata: &FrontendMetadata) -> Vec<GraphDelta> {
    use crate::rustc::crate_metadata;
    use crate::rustc::item_capture::*;
    use crate::rustc::item_capture::{capture_adt, capture_const_static, capture_mod, capture_type_alias};
    use crate::rustc::mir_capture::capture_function;
    use crate::rustc::node_builder::ensure_node;
    use crate::rustc::trait_capture::*;
    use crate::rustc::trait_capture::{capture_impl, capture_trait};
    use crate::rustc::type_capture::capture_function_types;
