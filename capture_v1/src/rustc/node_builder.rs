...
use crate::internal_graph::{DeltaCollector, NodeId, NodePayload};
...
pub(super) fn ensure_node<'tcx>(builder: &mut DeltaCollector, tcx: TyCtxt<'tcx>, def_id: DefId, cache: &mut HashMap<DefId, NodeId>, metadata: &FrontendMetadata) -> Option<NodeId> {
