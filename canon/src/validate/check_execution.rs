...
fn check_epochs(ir: &SystemState, idx: &Indexes, violations: &mut Vec<Violation>) {
...
fn check_ticks(ir: &SystemState, idx: &Indexes, violations: &mut Vec<Violation>) {
...
fn check_plans(ir: &SystemState, idx: &Indexes, violations: &mut Vec<Violation>) {
...
fn check_executions(ir: &SystemState, idx: &Indexes, violations: &mut Vec<Violation>) {
...
fn check_reward_monotonicity(ir: &SystemState, violations: &mut Vec<Violation>) {
...
fn check_gpu(ir: &SystemState, idx: &Indexes, violations: &mut Vec<Violation>) {
    for gpu in &ir.gpu_functions {
        ...
        if !gpu.properties.pure || !gpu.properties.no_alloc || !gpu.properties.no_branch
...
fn check_reward_collapse(ir: &SystemState, violations: &mut Vec<Violation>) {
