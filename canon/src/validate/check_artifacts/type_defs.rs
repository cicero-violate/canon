...
use crate::ir::{SystemState, StructKind};
use std::collections::{HashMap, HashSet};
pub fn check_structs(ir: &SystemState, idx: &Indexes, violations: &mut Vec<Violation>) {
    for s in &ir.structs {
            ...
            violations
                .push(
                    Violation::structured(
                        ...
                        s.id.clone(),
                        ViolationDetail::StructMissingModule {
            ...
            violations
                .push(
                    Violation::structured(
                        CanonRule::ExplicitArtifacts,
                        s.id.clone(),
                        ViolationDetail::TupleStructEmpty {
                            struct_id: s.id.clone(),
                        },
                    ),
                );
                ...
                violations
                    .push(
                        Violation::structured(
                            CanonRule::ExplicitArtifacts,
                            s.id.clone(),
                            ViolationDetail::StructEmptyDerive {
                                struct_id: s.id.clone(),
                            },
                        ),
                    );
...
pub fn check_enums(ir: &SystemState, idx: &Indexes, violations: &mut Vec<Violation>) {
    for e in &ir.enums {
            ...
            violations
                .push(
                    Violation::structured(
                        CanonRule::ExplicitArtifacts,
                        e.id.clone(),
                        ViolationDetail::EnumMissingModule {
                            enum_id: e.id.clone(),
            ...
            violations
                .push(
                    Violation::structured(
                        CanonRule::ExplicitArtifacts,
                        t.id.clone(),
                        ViolationDetail::TraitMissingModule {
                            trait_id: t.id.clone(),
                ...
                violations
                    .push(
                        Violation::structured(
                            ...
                            t.id.clone(),
                            ViolationDetail::TraitMissingSupertrait {
                                trait_id: t.id.clone(),
                                supertrait: bound.clone(),
                            },
                        ),
                    );
            }
                ...
                violations
                    .push(
                        Violation::structured(
                            CanonRule::TraitVerbs,
                            f.id.clone(),
                            ViolationDetail::TraitFunctionDuplicate {
