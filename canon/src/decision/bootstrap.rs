use crate::ir::{SystemState, Rule, Proof, ProofArtifact, ProofScope, Tick};
use super::{DSL_PREDICATE_ID, DSL_PROOF_ID, DSL_TICK_ID};
pub(super) fn ensure_dsl_proof(ir: &mut SystemState) {
...
pub(super) fn ensure_dsl_predicate(ir: &mut SystemState) {
...
pub(super) fn ensure_dsl_tick(ir: &mut SystemState) -> Result<(), ()> {
